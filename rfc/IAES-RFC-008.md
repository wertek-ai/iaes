...
It stays in Review until the release that carries it. Its decisions are about
schemas and text that **do not exist yet**; a memo cannot be Accepted before the
artifacts it names have been incorporated, and §6 defines Accepted as exactly
that. The 2.0 cut incorporates it and flips it.
