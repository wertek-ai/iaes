...
NORMATIVE = [
    ...
    # The adopted SDK profile (GOVERNANCE.md §9.2) and its reasoning. A claim
    # names a release and is checked against that release's definition, so
    # §9.4 requires the definition to travel inside the release.
    "surface.json",
    "SDK_SURFACE.md",
]
NORMATIVE_GLOBS = [
